...
스레드 코드의 데이터 레이스를 잡는 도구가 이 목록에 있다는 점도 짚어 둘 만해요. [[2026-08-05_CPP_동시성_센서수신과_제어루프|C++ 동시성 — 센서 수신과 제어 루프]]에서 "증상을 쫓지 말고 설계로 보장하라"고 했는데, 그 설계가 실제로 지켜졌는지 확인하는 자리가 여기예요.
