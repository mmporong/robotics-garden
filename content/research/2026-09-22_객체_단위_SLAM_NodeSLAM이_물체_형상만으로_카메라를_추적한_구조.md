...
<figure class="fig"><img src="../assets/2026-09-22_nodeslam_최적화_루프.png" alt="관측·형상 모델·측정 함수·지도와 카메라 네 갈래로 나눈 NodeSLAM 흐름도. RGB-D 프레임에서 물체를 분할해 형상 코드와 포즈를 초기화하고, 복원한 점유 격자를 깊이로 렌더해 잔차를 최소화한 뒤 키프레임 번들이 세 변수를 함께 갱신한다"><figcaption>원문 3~6절 설명을 바탕으로 새로 구성한 NodeSLAM 처리 흐름입니다. 오른쪽 끝에서 왼쪽으로 돌아오는 화살표가 형상과 포즈, 카메라를 함께 갱신하는 경로입니다.</figcaption></figure>
