---
publish: true
title: "URDF와 DDS 계약으로 완주한 JDAMR 실기 자율탐사"
...
tags:
  ...
  - URDF
  - DDS
description: "TurtleBot3에서 검증한 frontier 탐사를 JDAMR 실기체로 옮기며 차체 외곽, G4 LiDAR, Wi-Fi DDS의 책임 경계를 다시 정한 기록이에요."
---

SO101 팔을 연결하기 전, JDAMR 차체만으로 Cartographer SLAM과 Nav2 자율탐사를 실행했어요. 최종 상태는 `FINISHED`, 지도 저장은 `succeeded`였고 894×212셀 지도를 남겼어요.
...
JDAMR에서는 알고리즘 바깥의 계약이 결과를 좌우했어요. 차체 외곽은 URDF에서 읽어야 했고, 교체한 G4의 스캔 시간축과 `laser_link`를 일치시켜야 했어요. 로봇과 노트북 사이 DDS 지연도 안전 고장과 회복 가능한 지연으로 나눠야 했어요.
