...
<figure class="fig"><img src="../assets/2026-09-22_nodeslam_최적화_루프.png" alt="RGB-D 관측에서 시작해 추정 변수를 형상 복원과 확률적 렌더링으로 그린 뒤 잔차를 되돌려 세 변수를 함께 갱신하는 흐름"><figcaption>원문 4~6절 설명을 바탕으로 새로 구성한 NodeSLAM 최적화 루프입니다.</figcaption></figure>
